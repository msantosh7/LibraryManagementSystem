...
<% ArrayList<Document> docList = (ArrayList) request.getAttribute("overdueList"); 
...
while(iterator.hasNext()) {
	...
	<tr><td><%=doc3.getdocumentId()%></td>
		<td><%=doc3.getmemberId()%></td>
		<td><%=doc3.getborrowDate()%></td>
		<td><%=doc3.getreturnDate()%></td>
	</tr>
	<%
}
